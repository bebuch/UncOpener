...
UncOpener enables seamless opening of UNC network paths directly from your web browser. When installed and registered, it intercepts URLs with a custom scheme (e.g., `unc://server/share/path`) generated by the UncClickable extension and opens the corresponding network location.
